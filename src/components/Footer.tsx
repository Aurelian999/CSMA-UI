      ...
      <Container>
        <Row>
          ...
          <Col md={{ span: 3, offset: 1 }} sm={4} className="footer-col">
            <h3>Link-uri</h3>
            <p>
              <a href="/gdpr">Protectia datelor</a>
            </p>
            <p>
          ...
          <Col md={{ span: 3, offset: 1 }} sm={4} className="footer-col">
            ...
            <div className="contact-social">
              <SocialIcon
                url="https://www.facebook.com/bodychoice.cluj/"
                style={{ height: 40, width: 40 }}
              />
              <SocialIcon
                url="https://wa.me/40740428881"
                network="whatsapp"
                style={{ height: 40, width: 40 }}
              />
              <SocialIcon
                url="mailto:contact@body-choice.ro"
                network="mailto"
                style={{ height: 40, width: 40 }}
              />
              <a href="https://m.me/bodychoice.cluj">
                <img
                  alt="Contacteaza-ne pe messenger"
                  src={messenger}
                  style={{ height: 40, width: 40 }}
                />
              </a>
